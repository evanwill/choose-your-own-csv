...
choose-your-own-csv is a minimal static web template that publishes interactive nonlinear narrative stories from a spreadsheet.
It can load the spreadsheet from a CSV on the web (such as a published Google Sheet!), which enables live collaboration and prototyping with minimal set up.

You create story content and "choices" (links) in a spreadsheet following the "story-csv" conventions.
...
To create a story there is three basic steps:

1. create a spreadsheet following the "story-csv" conventions: "docs/spreadsheet_setup.md"
2. publish your spreadsheet online: "docs/spreadsheet_publish.md"
3. share your story: "docs/story_share.md"

## Technical

When a user visits your story website, javascript downloads the CSV from the link you configured, parses it using the [Papa Parse](https://www.papaparse.com/) library, and uses the data to present the "story pages".
...
The website uses query strings to track where the reader is in the story--you can always hit the back button or save the link to where you are!
